...
Local   cDesc1    := "Projeto: GED " 
Local   cDesc2    := "Autor: Casa China - Data: 15/02/2022" 
Local   cDesc3    := ""
Local   cDesc4    := "Descrição: Criacao de campos AC9 para controle. "
Local   cDesc5    := ""
Local   cDesc6    := ""
Local   cDesc7    := ""
Local   cMsg      := ""
...
*/
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDGED_1" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDGED_1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDGED_1" ) ) ) ;
