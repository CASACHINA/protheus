...
aAdd( aSX3, { ;
	...
	{ 12																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Credito IMCS'														, .T. }, ; //X3_TITULO
	{ 'Credito IMCS'														, .T. }, ; //X3_TITSPA
	{ 'Credito IMCS'														, .T. }, ; //X3_TITENG
	{ 'Credito IMCS'														, .T. }, ; //X3_DESCRIC
	{ 'Credito IMCS'														, .T. }, ; //X3_DESCSPA
	{ 'Credito IMCS'														, .T. }, ; //X3_DESCENG
	{ '@E 9,999,999.99'														, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZA8'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZA8_FILIAL+ZA8_CODTAB+ZA8_VERSAO'										, ; //CHAVE
	'Tabela Preço+Versão'													, ; //DESCRICAO
	'Tabela Preço+Versão'													, ; //DESCSPA
	'Tabela Preço+Versão'													, ; //DESCENG
	'U'																		, ; //PROPRI
