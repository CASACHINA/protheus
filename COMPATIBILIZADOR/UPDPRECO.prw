...
aAdd( aSIX, { ;
	'ZA8'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZA8_FILIAL+ZA8_PROCES+ZA8_ITEM'										, ; //CHAVE
	'Cod.Processo+Item'														, ; //DESCRICAO
	'Cod.Processo+Item'														, ; //DESCSPA
	'Cod.Processo+Item'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
