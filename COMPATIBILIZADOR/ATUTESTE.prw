...
User Function ATUTESTE( cEmpAmb, cFilAmb )
	...
	Local aButton   	:= {}
	Local aMarcadas 	:= {}
	Local cTitulo   	:= "ATUALIZAÇÃO DE DICIONÁRIOS E TABELAS DO SISTEMA (SIX/SX2/SX3/SX6)"
	Local cDesc1    	:= " "
	Local cDesc2    	:= "Descrição: ESTE PROGRAMA DEVE SER EXECUTADO EM AMBIENTE TESTE"
	Local cDesc3    	:= " "
	Local cDesc4    	:= "NÃO DEVE SER EXECUTADO EM AMBIENTE PRODUÇÃO!!!!!!!!"
	Local cDesc5    	:= " "
	// Local cDesc6    	:= ""
	// Local cDesc7    	:= ""
	Local lOk       	:= .F.
	...
	//Controle de atualização em migrações
...
Static Function PreCadCyberlog()
	...
	AutoGrLog( If(lAdd, "ZA2 Incluído", "ZA2 Alterado") )
...
Static Function FSAtuSX6()
	...
	'MV_TAFAMBR'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Identificação do ambiente do Reinf: 1 - Produção; '												, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'2 - Produção Restrita - Dados Reais'									, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	...
	'MV_TAFAMBE'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Identificação do Ambiente e-Social 1-Produção,    '					, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'2-Produção restrita-dados reais;'										, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	'3-Produção restrita-dados fictícios;'									, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'3'																		, ; //X6_CONTEUD
	''																		, ; //X6_CONTSPA
