...
/*/
//--------------------------------------------------------------------
User Function UPDCYB01( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
Local   cTitulo   := "ATUALIZAÇÃO DE DICIONÁRIOS E TABELAS DO SISTEMA (SX2/SX3/SIX)"
Local   cDesc1    := "Projeto: Cyberlog - Transferencia entre armazens " 
Local   cDesc2    := "Autor: Casa China - Data: 08/12/2022" 
Local   cDesc3    := ""
Local   cDesc4    := "Descrição: Criacao tabelas de controle do processo "
Local   cDesc5    := "de transferencia entre armazens no Cyberlog."
Local   cDesc6    := ""
Local   cDesc7    := ""
Local   cMsg      := ""
Local   lOk       := .F.
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UPDCYB01" )
				Else
					MsgStop( "Atualização não realizada.", "UPDCYB01" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'Cyberlog - Cab.Transf.Armazem'											, ; //X2_NOME
	'Cyberlog - Cab.Transf.Armazem'											, ; //X2_NOMESPA
	'Cyberlog - Cab.Transf.Armazem'											, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'Cyberlog - Item.Transf.Armazem'										, ; //X2_NOME
	'Cyberlog - Item.Transf.Armazem'										, ; //X2_NOMESPA
	'Cyberlog - Item.Transf.Armazem'										, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	{ 'ZA5'																	, .T. }, ; //X3_ARQUIVO
	{ '02'																	, .T. }, ; //X3_ORDEM
	{ 'ZA5_PROCES'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod Processo'														, .T. }, ; //X3_TITULO
	{ 'Cod Proceso'															, .T. }, ; //X3_TITSPA
	{ 'Process Code'														, .T. }, ; //X3_TITENG
	{ 'Codigo Processo'														, .T. }, ; //X3_DESCRIC
	{ 'Codigo Proceso'														, .T. }, ; //X3_DESCSPA
	{ 'Process Code'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'GetSXENum("ZA5", "ZA5_PROCES")'										, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 'Hr.Inclusao'															, .T. }, ; //X3_DESCRIC
	{ 'Hr.Inclusao'															, .T. }, ; //X3_DESCSPA
	{ 'Hr.Inclusao'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZA5'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'ZA5_STAREC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Status Rec.'															, .T. }, ; //X3_TITULO
	{ 'Status Rec.'															, .T. }, ; //X3_TITSPA
	{ 'Status Rec.'															, .T. }, ; //X3_TITENG
	{ 'Status Rec.'															, .T. }, ; //X3_DESCRIC
	{ 'Status Rec.'															, .T. }, ; //X3_DESCSPA
	{ 'Status Rec.'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ 'N=Não Enviado;A=Aguar.Conferência;C=Conferido;X=Erro ao Enviar WMS', .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'ZA5'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'ZA5_STAPED'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Status Ped.'															, .T. }, ; //X3_TITULO
	{ 'Status Ped.'															, .T. }, ; //X3_TITSPA
	{ 'Status Ped.'															, .T. }, ; //X3_TITENG
	{ 'Status Ped.'															, .T. }, ; //X3_DESCRIC
	{ 'Status Ped.'															, .T. }, ; //X3_DESCSPA
	{ 'Status Ped.'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ 'N=Não Enviado;A=Aguar.Separação;C=Conferido;X=Erro ao Enviar WMS', .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Doc.Trf.ERP'															, .T. }, ; //X3_TITULO
	{ 'Doc.Trf.ERP'															, .T. }, ; //X3_TITSPA
	{ 'Doc.Trf.ERP'															, .T. }, ; //X3_TITENG
	{ 'Doc.Trf.ERP'															, .T. }, ; //X3_DESCRIC
	{ 'Doc.Trf.ERP'															, .T. }, ; //X3_DESCSPA
	{ 'Doc.Trf.ERP'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZA5'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'ZA5_DATATR'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Dt.Trf.ERP'															, .T. }, ; //X3_TITULO
	{ 'Dt.Trf.ERP'															, .T. }, ; //X3_TITSPA
	{ 'Dt.Trf.ERP'															, .T. }, ; //X3_TITENG
	{ 'Dt.Trf.ERP'															, .T. }, ; //X3_DESCRIC
	{ 'Dt.Trf.ERP'															, .T. }, ; //X3_DESCSPA
	{ 'Dt.Trf.ERP'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Erro ERP'															, .T. }, ; //X3_TITULO
	{ 'Erro ERP'															, .T. }, ; //X3_TITSPA
	{ 'Erro ERP'															, .T. }, ; //X3_TITENG
	{ 'Erro ERP'															, .T. }, ; //X3_DESCRIC
	{ 'Erro ERP'															, .T. }, ; //X3_DESCSPA
	{ 'Erro ERP'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ 'N=Não enviado;R=Aguard.Receb.;S=Aguard.Separação;P=Aguard.ERP;X=Erro;T=Transferido'	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'ZA5'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'ZA5_DEPPED'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Dep.Ped.Cybe'														, .T. }, ; //X3_TITULO
	{ 'Dep.Ped.Cybe'														, .T. }, ; //X3_TITSPA
	{ 'Dep.Ped.Cybe'														, .T. }, ; //X3_TITENG
	{ 'Dep.Ped.Cybe'														, .T. }, ; //X3_DESCRIC
	{ 'Dep.Ped.Cybe'														, .T. }, ; //X3_DESCSPA
	{ 'Dep.Ped.Cybe'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZA5'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'ZA5_DEPREC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Dep.Rece.Cyb'														, .T. }, ; //X3_TITULO
	{ 'Dep.Rece.Cyb'														, .T. }, ; //X3_TITSPA
	{ 'Dep.Rece.Cyb'														, .T. }, ; //X3_TITENG
	{ 'Dep.Rece.Cyb'														, .T. }, ; //X3_DESCRIC
	{ 'Dep.Rece.Cyb'														, .T. }, ; //X3_DESCSPA
	{ 'Dep.Rece.Cyb'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZA6'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'ZA6_LOCORI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Local Origem'														, .T. }, ; //X3_TITULO
	{ 'Local Origem'														, .T. }, ; //X3_TITSPA
	{ 'Local Origem'														, .T. }, ; //X3_TITENG
	{ 'Local Origem'														, .T. }, ; //X3_DESCRIC
	{ 'Local Origem'														, .T. }, ; //X3_DESCSPA
	{ 'Local Origem'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'Posicione("ZA2", 1, cFilAnt, "ZA2_LOCPAD")'								, .T. }, ; //X3_RELACAO
	{ 'NNS'																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(134) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	{ 'ZA6'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'ZA6_LOCDES'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Local Destin'														, .T. }, ; //X3_TITULO
	{ 'Local Destin'														, .T. }, ; //X3_TITSPA
	{ 'Local Destin'														, .T. }, ; //X3_TITENG
	{ 'Local Destin'														, .T. }, ; //X3_DESCRIC
	{ 'Local Destin'														, .T. }, ; //X3_DESCSPA
	{ 'Local Destin'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'Posicione("ZA2", 1, cFilAnt, "ZA2_LOCB2B")'								, .T. }, ; //X3_RELACAO
	{ 'NNS'																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ Chr(134) + Chr(128)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	{ 'ZA2'																	, .T. }, ; //X3_ARQUIVO
	{ '16'																	, .T. }, ; //X3_ORDEM
	{ 'ZA2_LOCPAD'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Local Padrao'														, .T. }, ; //X3_TITULO
	{ 'Local Padrao'														, .T. }, ; //X3_TITSPA
	{ 'Local Padrao'														, .T. }, ; //X3_TITENG
	{ 'Local Padrao'														, .T. }, ; //X3_DESCRIC
	{ 'Local Padrao'														, .T. }, ; //X3_DESCSPA
	{ 'Local Padrao'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZA2'																	, .T. }, ; //X3_ARQUIVO
	{ '17'																	, .T. }, ; //X3_ORDEM
	{ 'ZA2_LOCB2B'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Local B2B'														, .T. }, ; //X3_TITULO
	{ 'Local B2B'														, .T. }, ; //X3_TITSPA
	{ 'Local B2B'														, .T. }, ; //X3_TITENG
	{ 'Local B2B'														, .T. }, ; //X3_DESCRIC
	{ 'Local B2B'														, .T. }, ; //X3_DESCSPA
	{ 'Local B2B'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZA6'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZA6_FILIAL+ZA6_PROCES+ZA6_ITEM'										, ; //CHAVE
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDCYB01" ) ) ) ;
